...
import { useMousePosition } from '@/src/hooks/use-animations'
import { gradients } from '@/src/lib/design-system'
import { gradientAnimations } from '@/src/lib/animation-config'
