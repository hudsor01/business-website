...
import type { SectionProps, AnimatedSectionProps } from '@/src/types/component-types'
import { animations, transitions } from '@/src/lib/design-system'
import { useScrollAnimation } from '@/src/hooks/use-animation-hooks'
