...
export const LazyFloatingElements = dynamic(
  () => import('@/src/components/animated/floating-elements'),
  {
...
export const LazyGradientBackground = dynamic(
  () => import('@/src/components/animated/gradient-background'),
  {
...
export const LazyAnimatedCard = dynamic(
  () => import('@/src/components/animated/animated-card'),
  {
...
export const LazyAnimatedText = dynamic(
  () => import('@/src/components/animated/animated-text'),
  {
...
export const LazyServicesSection = dynamic(
  () => import('@/src/components/sections/services-section').then(mod => ({ default: mod.ServicesSection })),
  {
...
export const LazyTechStackSection = dynamic(
  () => import('@/src/components/sections/tech-stack-section').then(mod => ({ default: mod.TechStackSection })),
  {
    loading: () => <SectionSkeleton />,
    ssr: true,
  },
...
export const LazyPricingSection = dynamic(
  () => import('@/src/components/sections/pricing-section').then(mod => ({ default: mod.PricingSection })),
  {
    loading: () => <SectionSkeleton />,
    ssr: true,
  },
...
export const LazyContactCTASection = dynamic(
  () => import('@/src/components/sections/contact-cta').then(mod => ({ default: mod.ContactCTA })),
  {
    loading: () => <SectionSkeleton />,
    ssr: true,
  },
...
export const LazyLeadMagnetSection = dynamic(
  () => import('@/src/components/sections/lead-magnet-section').then(mod => ({ default: mod.LeadMagnetSection })),
  {
    loading: () => <SectionSkeleton />,
    ssr: true,
  },
...
export const LazyTestimonialsCarousel = dynamic(
  () => import('@/src/components/testimonials-carousel'),
  {
...
export const LazyLeadMagnetForm = dynamic(
  () => import('@/src/components/forms/lead-magnet-form'),
  {
    loading: () => <FormSkeleton />,
    ssr: true,
  },
...
export const LazyNewsletterForm = dynamic(
  () => import('@/src/components/forms/newsletter-form'),
  {
    loading: () => <FormSkeleton />,
    ssr: true,
  },
