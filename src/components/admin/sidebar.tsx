...
import { NavDocuments } from '@/src/components/admin/nav-documents'
import { NavMain } from '@/src/components/admin/nav-main'
import { NavSecondary } from '@/src/components/admin/nav-secondary'
import { NavUser } from '@/src/components/admin/nav-user'
import {
  Sidebar,
  SidebarContent,
  SidebarFooter,
