...
import { AnimatedSection } from '@/src/components/sections/section'
import { SectionErrorBoundary } from '@/src/components/error/route-error-boundaries'
import {
  AnimatedText,
  AnimatedHeading,
} from '@/src/components/animated/animated-text'
import { AnimatedCard } from '@/src/components/animated/animated-card'
import { LeadMagnetSection } from '@/src/components/sections/lead-magnet-section'
import { generateServiceMetadata } from '@/src/lib/metadata/metadata-utils'
