...
export type ContactFormValues = import('@/src/types/form-types').ContactFormData
export type NewsletterFormValues = import('@/src/types/form-types').NewsletterFormData
export type LeadMagnetFormValues = import('@/src/types/form-types').LeadMagnetFormData