...
export const commonLazyComponents = {
  ...
  DataTable: () => createLazyNamedComponent(() => import('@/src/components/admin/data-table'), 'DataTable'),
  AdminCharts: () => createLazyNamedComponent(() => import('@/src/components/admin/charts/chart-area-interactive'), 'ChartAreaInteractive'),
  
  // Charts and visualizations (using existing admin charts)
  AnalyticsChart: () => createLazyNamedComponent(() => import('@/src/components/admin/charts/chart-line-interactive'), 'ChartLineInteractive'),
  
  // Contact form components as modal alternatives
  ContactForm: () => createLazyNamedComponent(() => import('@/src/components/forms/contact-form'), 'ContactForm'),
  
  // Heavy third-party integrations
  CalendarWidget: () => createLazyNamedComponent(() => import('@/src/components/booking/cal-com-widget'), 'CalComWidget'),
}